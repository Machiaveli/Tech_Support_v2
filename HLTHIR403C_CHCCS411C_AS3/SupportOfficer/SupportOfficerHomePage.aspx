...
&nbsp;&nbsp;&nbsp;
    ...
    <br />
    <br />
    &nbsp;&nbsp;&nbsp;<asp:GridView ID="GridViewCustomers" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="CustomerID" DataSourceID="DataSourceSearchCustByID" AllowPaging="True">
        <Columns>
...
&nbsp;<asp:SqlDataSource ID="DataSourceListMyIncidents" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Customers]"></asp:SqlDataSource>

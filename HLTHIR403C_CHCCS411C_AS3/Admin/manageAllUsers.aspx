...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    &nbsp;
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <br />
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="UserID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" style="text-align: center" Width="900px" OnRowUpdating="GridView1_RowUpdating1" OnRowEditing="GridView1_RowEditing">
    ...
    <asp:GridView ID="GridViewDisplayUsers" runat="server" AllowPaging="True" AllowSorting="True" CellPadding="4" Width="900px" DataSourceID="sqlSearchLastName" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" DataKeyNames="UserID" Visible="False" OnRowUpdating="GridViewDisplayUsers_RowUpdating" OnRowEditing="GridViewDisplayUsers_RowEditing" >
        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
        <Columns>
            <asp:BoundField DataField="UserID" HeaderText="UserID" ReadOnly="True" SortExpression="UserID" />
            <asp:TemplateField HeaderText="FirstName" SortExpression="FirstName">

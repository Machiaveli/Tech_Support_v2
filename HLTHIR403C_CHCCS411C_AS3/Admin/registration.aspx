<%@ Page Title="Add New User" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="registration.aspx.cs" Inherits="HLTHIR403C_CHCCS411C_AS3.registration1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <br />
                <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" BorderColor="White" BorderStyle="Solid" BorderWidth="2px" CellPadding="4" DataKeyNames="UserID" DataSourceID="lastUsedUserName" ForeColor="#333333" GridLines="None" Height="50px" Width="330px">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <CommandRowStyle BackColor="#E2DED6" Font-Bold="True" />
                    <EditRowStyle BackColor="#999999" />
                    <FieldHeaderStyle BackColor="#E9ECF1" Font-Bold="True" />
                    <Fields>
                        <asp:BoundField DataField="UserID" HeaderText="Last User ID used:" ReadOnly="True" SortExpression="UserID" />
                    </Fields>
        ...
        <br />
                <asp:CreateUserWizard ID="CreateUserWizard2" runat="server" BackColor="#F7F6F3" BorderColor="#E6E2D8" BorderStyle="Solid" BorderWidth="1px" ContinueDestinationPageUrl="~/Admin/registration.aspx" Font-Names="Verdana" Font-Size="Medium" ForeColor="#003366" LoginCreatedUser="False" OnCreatedUser="CreateUserWizard2_CreatedUser" Width="330px">
                            ...
                            <ContentTemplate>
                                <table style="font-family:Verdana;font-size:100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="UserName" runat="server" CssClass="nonEditable" onKeyDown="javascript: return false;" onkeypress="javascript:return false;" onPaste="javascript: return false;"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName" Display="Dynamic" ErrorMessage="User Name is required." ToolTip="User Name is required." ValidationGroup="CreateUserWizard2">*</asp:RequiredFieldValidator>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="EmailRequired" runat="server" ControlToValidate="Email" Display="Dynamic" ErrorMessage="E-mail is required." ToolTip="E-mail is required." ValidationGroup="CreateUserWizard2">*</asp:RequiredFieldValidator>
                                    ...
                                    <tr>
                                        <td align="right">&nbsp;</td>
                                        <td>
                                            <asp:Label ID="Label5" runat="server" Font-Size="Smaller" ForeColor="Red" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                    ...
                                    <tr>
                                        <td align="center" colspan="2">
                                            <asp:CompareValidator ID="PasswordCompare" runat="server" ControlToCompare="Password" ControlToValidate="ConfirmPassword" Display="Dynamic" ErrorMessage="The Password and Confirmation Password must match." ValidationGroup="CreateUserWizard2" ForeColor="Red"></asp:CompareValidator>
                                        </td>
                                    </tr>
                                    <tr>
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="CreateUserWizard2" />
        </Triggers>
    </asp:UpdatePanel>
&nbsp;<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [Users] WHERE [UserID] = @UserID" InsertCommand="INSERT INTO [Users] ([UserID], [UserName], [FirstName], [LastName], [Address], [City], [State], [ZipCode], [Phone], [Email], [Password], [UserType]) VALUES (@UserID, @UserName, @FirstName, @LastName, @Address, @City, @State, @ZipCode, @Phone, @Email, @Password, @UserType)" SelectCommand="SELECT * FROM [Users]" UpdateCommand="UPDATE [Users] SET [UserName] = @UserName, [FirstName] = @FirstName, [LastName] = @LastName, [Address] = @Address, [City] = @City, [State] = @State, [ZipCode] = @ZipCode, [Phone] = @Phone, [Email] = @Email, [Password] = @Password, [UserType] = @UserType WHERE [UserID] = @UserID">
    ...
    <asp:SqlDataSource ID="EmailCheck" runat="server"></asp:SqlDataSource>
